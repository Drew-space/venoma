      ...
      >
        {products.map((product, index) => {
          ...
          return (
            <SwiperSlide
              key={index}
              className="selected-none w-full cursor-pointer "
            >
              <div className="bg-gray-50 h-[360px] items-center flex justify-center ">
                <Image
                  src={image}
                  width={240}
                  height={240}
              ...
              <div className="w-full pt-4 flex flex-col gap-4 ">
                ...
                <p className=" font-semibold text-accent-2 "> {price} </p>
              </div>
            </SwiperSlide>
          );
        })}
